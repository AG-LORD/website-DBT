...
import { QuizResult } from "../entities/QuizResult";  // relative import fixed
  ...
  if (showResult) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6 flex items-center justify-center">
        ...
        >
          <Card className="max-w-2xl bg-white/90 backdrop-blur-sm border-none shadow-2xl">
                ...
                <div className="space-y-3">
                  {currentQuestions[currentQuestion].options.map((option, index) => (
                    <Button
                      key={index}
                      variant="outline"
                      className="w-full text-left justify-start p-6 h-auto hover:bg-blue-50 hover:border-blue-300 transition-all duration-200"
                    ...
                    >
                      <div className="flex items-center gap-4 w-full">
                        ...
                        <p className="text-lg text-gray-700">{option}</p>
                      </div>
                    </Button>
                  ))}
                </div>
